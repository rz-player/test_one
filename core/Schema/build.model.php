...
$xPDO->log(xPDO::LOG_LEVEL_INFO, 'Модель сгенерирована, Model generation done');
...
/* для соответствия PSR-4(по дефолту PSR-0)дописан перенос свежесгенерированных файлов на 2 директории выше.*/
...
$xPDO->log(xPDO::LOG_LEVEL_INFO, 'Файлы перенесены, Files Moved');